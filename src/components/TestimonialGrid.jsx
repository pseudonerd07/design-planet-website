...
const TestimonialGrid = () => {
  return (
    <>
      <h1 className='text-center text-6xl font-semibold mt-10'>Testimonials</h1>
      <section className='max-w-7xl my-15 m-auto grid grid-cols-1 gap-5 sm:gap-14 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6'>
