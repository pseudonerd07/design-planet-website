...
const HeroSection = () => {
  return (
    <section className='w-full pt-10 min-h-screen bg-gradient-to-r from-[rgb(15,30,68)] via-[#27448D] to-[#3F4088] bg-amber-400-200 text-white md:flex md:items-center md:justify-center'>
      <div className='max-w-7xl mx-auto px-6 md:px-10 md:py-20 grid grid-cols-1 md:grid-cols-12 items-center gap-10 '>
        {/* Text Content */}
        <div className='md:col-span-6  md:text-left'>
          ...
          <div className='mt-4 md:flex  md:justify-items-start md:items-center p-2'>
            ...
            <div className='bg-white font-semibold text-gray-700 text-center  mt-5 w-full md:w-auto mx-0 rounded-sm py-2 px-7 md:rounded-4xl hover:bg-gray-400 hover:cursor-pointer transition-all mr-10 shadow-2xl hover:scale-125 animate-pulse'>
              Contact
            </div>
          </div>
        </div>
        ...
        {/* Hero Image */}
        <div className='md:col-span-6 flex justify-left md:justify-center md:w-fit'>
          <img
            src={heroImage}
